...
public class DataGroup4_Robustness {
	private int K=1;
	...
	public void createConstraints() {
		try {
			...
			type3_y(8, 2, 20);
			type3_y(9, 2, 21);
			type2_y(10, 3, 22, 4, 23);
			type2_y(11, 1, 24, 4, 25);
			type2_y(12, 1, 26, 3, 27);
			type3_y(13, 3, 28);
			type2_y(14, 1, 29, 4, 30);
			type2_y(15, 2, 31, 3, 32);
	...
	public static void main(String args[]) {
		...
		for (int bgt=20;bgt<29;bgt++) {
			DataGroup4_Robustness ex = new DataGroup4_Robustness();
			ex.setK(bgt);
			//ex.setK(6);
			ex.optimize();
//		ex.printC();
