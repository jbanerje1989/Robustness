...
public class DataGroup5_Robustness {
	private int K=1;
	...
	public void createConstraints() {
		try {
			...
			type3_y(8, 1, 18);
			type2_y(9, 3, 19, 4, 20);
			type2_y(10, 3, 21, 4, 22);
			type3_y(11, 3, 23);
			type2_y(12, 1, 24, 2, 25);
			type2_y(13, 0, 26, 3, 27);
			type3_y(14, 1, 28);			
	...
	public static void main(String args[]) {
		...
		for (int bgt=29;bgt<30;bgt++) {
			DataGroup5_Robustness ex = new DataGroup5_Robustness();
			ex.setK(bgt);
			//ex.setK(6);
			ex.optimize();
//		ex.printC();
